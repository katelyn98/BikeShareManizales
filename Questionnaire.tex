...
\Qitem{\Qq{What are the main reasons that you do not use the CityBioBike bike sharing system? Select all that apply.}
    ...
    \begin{Qlist}
    \item[]\QO{} I prefer the bus \hskip0.3cm \QO{} I own a motorvehicle \hskip0.3cm \QO{} No bike stations near me \hskip0.5cm 
    \item[]\QO{} I don't think it's safe \hskip0.5cm \QO{} My destination is within walking distance
    \item[]\QO{} Too many hills on my route \hskip0.3cm \QO{} Other: \Qline{2cm}\\
    \end{Qlist}
\vspace{0.1cm}
