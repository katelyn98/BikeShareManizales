...
\vspace{0.1cm}
\renewcommand{\QO}{$\Box$}
\Qitem{\Qq{What are the main reasons you use it? Select all that apply.} 
}
\begin{Qlist}
...
\vspace{0.1cm}
\Qitem{\Qq{Please provide any suggestions about how CityBioBike can improve in any of the areas listed above. }} \Qline{17cm}\\ \Qline{17cm}\\ \Qline{17cm}
...
\renewcommand{\QO}{$\ocircle$}
\textbf{15. How likely are you to start using or continue using CityBioBike if the following were offered?} \\
