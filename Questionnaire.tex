...
%%%% NO TITLE!
%%% Don't need number 3
%%Have you ever heard of CityBioBike
%%Add not sure to question 5
%%are you a frequent user right now, how many times a week do you use it
%%Adjust order for question 7
%%Question 8 5-point scale strongly agree and disagree and neutral 
%%scale based on the factor to not be biased
%% get rid of 9j and 9k
...
\Qitem{ \Qq{Have you ever used CityBioBike?}
...
\renewcommand{\QO}{$\Box$}
\Qitem{ \Qq{How do you characterize the infrastructure and policies set up for bicycles in Manizales, Colombia? Choose the 3 adjectives that you feel most align with them. }
    \begin{Qlist}
    \item[]\QO{} Outdated \hskip1cm \QO{} Technologically Advanced \hskip1cm \QO{} Unsafe travel conditions 
    \item[]\QO{} Not reliable \hskip0.7cm \QO{} Complicated \hskip0.6cm \QO{} Expensive \hskip0.4cm \QO{} Enforced Rules \hskip1cm \QO{} Inefficent
    \item[]\QO{} Overused \hskip1.1cm \QO{} Not easily accessible \hskip1cm \QO{} Other: \Qline{5cm}
    \end{Qlist}
}
\vspace{0.1cm}

\Qitem{\Qq{If you answered yes to Q4: What are the main reasons why you use a CityBioBike? Select all that apply.} 
    \begin{Qlist}
...
\Qitem{\Qq{Identify below which factors strongly influence why you do or don't like CityBioBike as a mode of transportation.} \\
\textbf{Factors}\Qtab{7cm}{\textbf{Influences why I do}\hskip1cm \textbf{Influences why I don't}}\\
\QItem[a]{ \Qq{Travel times are too long} \hskip1.8cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[b]{ \Qq{Stress inducing} \hskip3.7cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[c]{ \Qq{Not technologically advanced} \hskip1.2cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[d]{ \Qq{Not available when I need it}\hskip1.6cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[e]{ \Qq{Breaks down a lot}\hskip3.4cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[f]{ \Qq{Too crowded}\hskip4.2cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[g]{ \Qq{Not clean}\hskip4.7cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[h]{ \Qq{Too expensive}\hskip4cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[i]{ \Qq{Complicated registration process}\hskip0.7cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[j]{ \Qq{I need to exercise}\hskip3.6cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}

\QItem[k]{ \Qq{Not easily accessible}\hskip3.3cm {disagree \Qrating{3} agree} \hskip0.5cm {disagree \Qrating{3} agree}}\\
}
\vspace{0.1cm}
