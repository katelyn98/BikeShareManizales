...
\Qitem{ \Qq{Did you know there was a bike sharing system in Manizales, Colombia?}\\
\QO{} yes \hskip2cm \QO{} no \hskip2cm \QO{} not sure}{}

\vspace{0.1cm}

\Qitem{\Qq{Do you live within a 10 minute walk from a bike sharing station?}\\
\QO{} yes \hskip2cm \QO{} no \hskip2cm \QO{} not sure}{}

\vspace{0.1cm}

\Qitem{ \Qq{Have you ever used the bike sharing system before? (If no, go to question 13.)}\\
...
\Qitem{ \Qq{How many times do you use the bike sharing system on avg in a week?: }\\\hskip2cm \QO{}
...
\textbf{10. Please rate how the bike sharing system in Manizales is doing with respect to each category listed below.} \\
\\
...
\vspace{0.1cm}
\Qitem{\Qq{Please provide any suggestions about how Manizales can improve in any of the areas listed above. }} \Qline{17cm}\\ \Qline{17cm}\\ \Qline{17cm}

\textbf{Proceed to question 15.}\\

\vspace{0.1cm}
\renewcommand{\QO}{$\Box$}
\Qitem{\Qq{Please identify below which factors play a role in why you are not a frequent user of the bike sharing system in Manizales, Colombia.}
    \begin{Qlist}
...
\renewcommand{\QO}{$\ocircle$}
\Qitem{\Qq{Did you know that the bike sharing system is free to use?}\hskip1cm\QO{} yes \hskip1cm \QO{} no}{}
\vspace{0.1cm}
\renewcommand{\QO}{$\Box$}
\Qitem{\Qq{What are the main reasons that you do not use the bike sharing system? Select all that apply.}
\begin{Qlist}
    \item[]\QO{} Safety on roads \hskip1.5cm \QO{} Quality of bikes \hskip1.8cm \QO{} No bike stations near me 
    \item[]\QO{} Travel time is too long \hskip0.3cm \QO{} I don't think it's reliable \hskip0.3cm \QO{} Too many hills on my route 
    \item[]\QO{} I prefer the bus \hskip1.5cm \QO{} My destination is within walking distance
...
\renewcommand{\QO}{$\ocircle$}
\textbf{15. How likely are you to start using or continue using the bike sharing system if the following were offered?} \\
